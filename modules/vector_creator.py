...
def create_vector_embeddings(chunk_size, overlap_size):
    ...
    average_length_of_a_podcast = sum(len(i) for i in df["text"]) / len(df["text"])
    ...
    for index, row in df.iterrows():
        ...
        for chunk in chunks:
            ...
            chunk_vector = chunk_to_vector(chunk, model_name_or_path)
